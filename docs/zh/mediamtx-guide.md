# Go NVR MediaMTX 集成指南

## 概述

MediaMTX 是一个功能强大的媒体服务器，可以作为 Go NVR 的 RTSP 代理服务器。它提供了 RTSP 到 WebRTC、HLS、WebRTC 等协议的转换功能，特别适合与 Go NVR 集成使用。
...
MediaMTX 为 Go NVR 提供了强大的媒体处理能力，通过合理的配置可以实现：
